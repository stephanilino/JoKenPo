...
/*SONS*/
const audioWin = new Audio("game/sounds/winning.wav")
const audioLose = new Audio("game/sounds/losing.wav")
...
function reset() {
    ...
    imgUser.innerHTML = "<img src='game/images/" + player1 + ".png'>"
    imgPc.innerHTML = ""
}
...
function playPc() {
    ...
    player2 = opt[num]
    imgPc.innerHTML = "<img src='game/images/" + player2 + ".png'>"
    analyze()
}
